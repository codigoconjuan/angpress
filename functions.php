...
class wp_ng_theme {
	...
	function enqueue_scripts() {
		...
		wp_enqueue_script( 'angular-core', 'https://ajax.googleapis.com/ajax/libs/angularjs/1.5.7/angular.min.js', array( 'jquery' ), '1.0', false );
		...
		wp_enqueue_script( 'ng-resource', '//code.angularjs.org/1.5.7/angular-resource.js', array( 'angular-core' ), '1.0', false );
	...
	function my_awesome_route() {
			register_rest_route('wp/v2', '/juan', array(
					'methods' => 'GET',
	...
	function my_awesome_route_callback($data) {
		$new_data = array('name' => 'Juan De la tore', 'age' => 29, 'location' => 'Mexico');
